...
func TestApiKeyAuth(t *testing.T) {
	tokenAuth := TokenAuthentication(func(token string) (any, error) {
		if token == validToken {
...
func TestApiKeyAuthCtx(t *testing.T) {
	tokenAuthCtx := TokenAuthenticationCtx(func(ctx context.Context, token string) (context.Context, any, error) {
		if token == validToken {
